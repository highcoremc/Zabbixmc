  ...
  private contents: {
  ...
  }[] = [
    {
      ...
      content:
          ...
          '<p class="accordion-text">Важно 1.2 Начав играть на наших серверах, Вы автоматически подтверждаете своё согласие с данным сводом правил.</p>\n' +
    ...
    },
    {
      ...
      content:
          '<p class="accordion-text">Важно 5.1 Деньги, потраченные на услуги сервера, не возвращаются не при каких обстоятельствах.</p>\n' +
