...
export default class extends Vue {
  ...
  private contents: {
    ...
    },
    {
      ...
      content:
          '<p class="accordion-text">3.1 Запрещено всячески мешать другим игрокам играть на сервере.</p>\n' +
          '<p class="accordion-text">3.2 Запрещено мошенничество, намеренный обман администрации.</p>\n' +
          '<p class="accordion-text">3.3 Администрация НЕ обязана возвращать вещи потерянные игроком.</p>\n' +
          '<p class="accordion-text">3.4 Администрация НЕ обязана осуществлять Вам помощь в виде увеличения игрового баланса, помощь в постройке и т.п.</p>\n' +
          '<p class="accordion-text">3.5 Запрещено попрошайничество (выпрашивать что-либо у администрации/игроков).</p>\n' +
          ...
          '<p class="accordion-text">3.8 Игроку запрещено пользоваться любыми сторонними программами для облегчения или изменения игрового процесса.</p>\n' +
    ...
    },
    {
      ...
      content:
          ...
          '<p class="accordion-text">4.3 Донатер не имеет право убивать во флае, режиме "бога", а также в ванише (режим невидимки).</p>\n' +
          '<p class="accordion-text">4.4 Донатер не имеет право давать бан/кик с причиной "за разбаном в скайп", с нецензурной лексикой, с просьбой о добавлением в регион или оскорблением игрока.</p>\n' +
          ...
          '<p class="accordion-text">4.9 Донатер не имеет права раздавать игровые вещи полученные на сервере или от администрации другим игрокам.</p>\n' +
